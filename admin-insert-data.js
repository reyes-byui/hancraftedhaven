// Admin script to insert test data using service role key (bypasses RLS)
...
async function insertTestData() {
  ...
  const orderItems = [
    ...
    {
      id: '45821f04-b2c1-4b3e-95c6-2b9854a13c28',
      order_id: 'e0e419f1-ec8f-40fd-89c5-4beabb13f4b9',
      product_id: '7895d23c-8b21-4d5e-a987-12c345f67890',
      seller_id: '4513475f-53e1-43fa-83dd-635aca8017a7',
      product_name: 'GRANDYA Advanced Pottery Workshop',
      product_price: 25.60,
      quantity: 1,
      subtotal: 25.60,
      created_at: '2025-08-07T19:15:22.445123+00:00',
      customer_id: '5c6fb69e-6537-49dd-8766-68ce1beb0274',
      status: 'pending'
    },
    {
      id: '89b32c1f-d4e5-4a6b-8c9d-3e2f5a8b9c1d',
      order_id: 'e0e419f1-ec8f-40fd-89c5-4beabb13f4b9',
      product_id: '1a2b3c4d-5e6f-7890-abcd-ef1234567890',
      seller_id: 'a805530e-b9a6-4673-b7bb-3675a19dc89a',
      product_name: 'Bebemoo Premium Baby Collection',
      product_price: 16.25,
      quantity: 1,
      subtotal: 16.25,
      created_at: '2025-08-07T19:15:22.445123+00:00',
  ...
  console.log('\n🎉 SUCCESS! Your marketplace statistics should now show:')
  console.log(`📊 Registered Customers: ${customerCount}+`)
  console.log(`📊 Products Sold: ${deliveredCount}+`)
}
